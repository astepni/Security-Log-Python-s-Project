...
to_json = [
    Logs('2025-02-16', '12:01:23', '192.168.1.10', 'FAILED'),
    Logs('2025-02-16', '12:01:24', '192.168.1.10', 'FAILED'),
    Logs('2025-02-16', '12:01:25', '192.168.1.10', 'FAILED')
]

logs_dict_list = [log.__dict__ for log in to_json]

with open("plik_list_comprehension.json", "w") as plik:
    json_string = json.dumps(logs_dict_list, indent=4)
